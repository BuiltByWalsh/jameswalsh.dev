...
## Arc was GOAT, But it's Time to Move On
...
2. The command pallet interface surrounding search _(command pallets rock, they are an amazing affordance and should be used more across the board)_.
...
5. Profiles that help you group not only group your tabs, but properly segment them for privacy reasons so that annoying cookies don't follow you everywhere you go _(looking at you LinkedIn & Google)_.
...
<br />
Dia promises to be this super AI forward, super-powered browser. Built from the ground up with a different browsing
experience in mind. But the UX today is largely a Safari clone with an AI chat thread on the right hand side of the
screen. And that in and of itself is somewhat useful. I can imagine serious utility in not needing to have an LLM scrape
links I'm pasting in as I go, and having the chat window have the context of the current page I'm on seems like a good
deal, in so far as I there are strict privacy controls surrounding when I want the LLM on or totally turned off.
...
thought through simple menu toggles. In Dia? Nothing. What if I want to give the chat thread I'm on access to every tab
I have open, or collect context from many sources at once to power some deep research task? Eh, sorry. That's not really
a thing. It's clear that Dia is leveraging AI. But in an overtly opaque way that makes really using it as an AI
superpower challenging. I have no insight into what's happening. I have no idea what information browser company is
collecting surrounding my personal browsing data.
